...
namespace AirportWebApi.Tests.Data
{
    public class DataSourceStub
    {
        private static readonly Lazy<DataSourceStub> LazyDataSourceStub = new Lazy<DataSourceStub>(() => new DataSourceStub());
        public static DataSourceStub Instance => LazyDataSourceStub.Value;
